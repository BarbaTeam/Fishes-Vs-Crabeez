...
class WaveEvent extends game_event_1.GameEvent {
    ...
    onEventBirth() {
        var _a;
        super.onEventBirth();
        const amount = (0, random_1.biasedRandint)(this._waveDifficulty.waveCount, 4.5, WaveEvent.MIN_AMOUNT_OF_ENNEMY, WaveEvent.MAX_AMOUNT_OF_ENNEMY + 1, 1 + this._waveDifficulty.harshness);
