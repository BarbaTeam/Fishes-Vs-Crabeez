// e2e/tests/ergo-player-management.spec.ts
import { test, expect } from '@playwright/test';
import { testUrl } from '../e2e.config';
import { ChoiceButtonFixture } from '@app/shared/components/choice-button/choice-button.fixture';
import { ErgoHomePageFixture } from 'e2e/page-objects/ergo-home-page.fixture';
import { ChildListPageFixture } from 'e2e/page-objects/child-list-page.fixture';
import { NewChildPageFixture } from 'e2e/page-objects/new-child-page.fixture';
import { ChildConfigPageFixture } from 'e2e/page-objects/child-config-page.fixture';
import { ChildStatsPageFixture } from 'e2e/page-objects/child-stats-page.fixture';
